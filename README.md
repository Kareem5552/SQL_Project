...
2. [`02_top_paying_skills.sql`](./1_EDA/02_top_paying_skills.sql.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](./1_EDA/03_optimal_skills.sql.sql) – combined demand/salary optimization query
